...
namespace Automationassignment_01.Tests
{
    ...
    public sealed class BookingLifecycleTests : TestBase
    {
        ...
        [Test]
        [Category("Regression")]
        public void TC13_BookingPersistsAfterRelogin()
        ...
        public void TC14_MultipleBookingsAreDisplayedInItinerary()
        ...
        [Test]
        [Category("Regression")]
        public void TC15_BookingCanBeCancelledAfterRelogin()
        ...
        public void tc_17checkingforpageheading()
        {
            ...
            //Assert.That(
            //    bookedit.IsLoaded(),"the page did not load "
            //    );
            bookedit.SelectOrder(orderid);
            Assert.That(
                bookedit.IsOrderDisplayed(orderid),Is.True,"orderid is not displayed"
